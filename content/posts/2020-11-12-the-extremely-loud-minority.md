...
> Always remember that although a **subset of the JavaScript community can be very loud**, they represent a **paltry portion of the web as a whole**. This means that when _they_ say something like "CSS sucks" — what they mean is "CSS sucks for a small subset of less than 1 percent of the web".
